...
class ClientService:
    ...
    def client_login(self, client_id: str, client_secret: str, expires_in: int = None) -> str:
        ...
        try:
            ...
            if not client_db.is_active:
                ...
                raise InvalidCredentialsException(detail="Cliente está inativo")
    ...
    def update_client_secret(self, client_id: str) -> Dict[str, str]:
        ...
        Raises:
            ...
            InvalidCredentialsException: Se o cliente estiver inativo
        ...
        except (ResourceNotFoundException, InvalidCredentialsException):
