# app/api/v1/endpoints/active_species.py
"""
Endpoints para consulta rápida de espécies ativas.

Este módulo define rotas simplificadas para obter espécies ativas
